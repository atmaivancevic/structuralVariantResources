...
- [2.2 Stuctural variant calling methods](#22-stuctural-variant-calling-methods)   
  ...
  - [2.2.3 Read depth (RD)](#read-depth-rd)  
...
- [GenePANDA](http://genepanda.tianlab.cn): A novel network-based gene prioritizing tool for complex diseases. [Yin et al 2017, Sci Rep](https://www.nature.com/articles/srep43258).   
**Note: software link (from paper) appears to be broken!** 
